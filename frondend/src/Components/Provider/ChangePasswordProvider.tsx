import React, { useState } from 'react';
 // Ensure this API call returns success/error messages
import { toast } from 'react-hot-toast'; // Optional for better user notifications
import { Navigate, useNavigate } from 'react-router-dom';
import { changePassword } from '../../Api/Provider';

const ChangePasswordProvider: React.FC = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-100">
            <div className="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
                <h2 className="text-2xl font-bold text-center text-red-600 mb-6">Change Password P</h2>
